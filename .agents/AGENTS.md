# Project-Scoped Rules (RewardWithoutGuilt)

This file contains style guidelines, behavioral constraints, and instructions for AI agents collaborating on the **RewardWithoutGuilt** project.

## Project Guidelines

### Coding Style & Standards
- **Language**: Kotlin is the primary language for Android development in this project.
- **UI Framework**: Use Jetpack Compose for building user interfaces.
- **Architecture**: Adhere to modern Android development practices (e.g., MVVM architecture, clean separation of UI and business logic).

### Component Design
- Keep Compose components focused, reusable, and modular.
- Avoid placing heavy business logic directly in UI components. Use ViewModels or dedicated domain layers.

## Customization Instructions
You can append specific instructions or constraints here to guide agent actions for future tasks.
